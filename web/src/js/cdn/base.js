    ...
    switch (confirmFlag) {
        case 1:
            html =
                ...
                '    <div style="position:absolute;top: 50%;left: 50%;margin-top:-105px;margin-left: -173px;width: 345px; border-radius: 5px; overflow:hidden;background-color: #fff;">'+
                '        <div style="min-height: 85px;border-radius: 5px 5px 0 0;">'+
                '            <div style="text-align: center;height:50px;line-height:50px;color: #fff;font-size: 17px;font-weight:bold;background:#fe6e7f;border-radius: 5px 5px 0 0;">'+
                title+
                '            </div>'+
                '            <div style="margin-top: 30px;color: #444;font-size: 14px;text-align: center;padding: 0 10px;word-break: break-all;margin-bottom: 30px;line-height:21px;">'+
                str+
                '            </div>'+
                '        </div>'+
                '        <div class="clearfix" style="border-top:1px solid #e1e1e1;font-size:15px;box-sizing:border-box;width:100%;">'+
                '            <span id="affirm" style="width:170px;height:50px;border-right:1px solid #e1e1e1; text-align:center;line-height:50px;color:#fe6e7f;display:inline-block;">'+
                '                确认'+
                '            </span>'+
                '            <span id="cancel" style="width:170px;height:50px;text-align:center;line-height:50px;color:#666;display:inline-block;">'+
                '                取消'+
                '            </span>'+
                '        </div>'+
                '    </div>'+
        ...
        case 2:
            html =
                ...
                '            </div>'+
                '        </div>'+
                '        <div style="font-size:15px;box-sizing:border-box;border-top:1px solid #e1e1e1;">'+
                '            <span id="affirm" style="width:345px;height:50px;text-align:center;line-height:50px;color:#fe6e7f;display:block;cursor: pointer;">'+
                btnTitle+
                '            </span>'+
                '        </div>'+
                '    </div>'+
