...
function scrollside(){
    var box = $(".box");
    //获得最后一张照片的整体高度,就是到顶部的高度
    var lastboxHeight = box.last().get(0).offsetTop+Math.floor(box.last().height()/2); //距离顶部的高度加上最后一张图片的一半
    var documentHeight = $(document).width(); //当前的高度
