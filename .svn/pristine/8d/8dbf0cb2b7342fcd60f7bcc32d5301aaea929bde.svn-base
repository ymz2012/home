    ...
    canEatIndex.prototype.bindEven = function(){
        ...
        var evenFun = {
            selectTypeFun:function(e){
                ...
                if(local_flag){
                    window.location.href =local_domain + "/can_eat_list.html?type_id=" + type_id + "&hym_title=" + hym_title;
                }else{
                    window.location.href = hym_domain + "/ubabyFood/list.htm?type_id=" + type_id + "&hym_title=" + hym_title;
                }
            ...
            selectGoodFun:function(e){
                ...
                var hym_title = encodeURIComponent($(this).data("title"));
                if(local_flag){
                    window.location.href =local_domain + "/can_eat_detail.html?food_id=" + food_id + "&hym_title=" + hym_title;

                }else{
                    window.location.href = hym_domain + "/ubabyFood/detail.htm?food_id=" + food_id + "&hym_title=" + hym_title;
